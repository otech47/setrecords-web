...
var TrackWizardStep2 = React.createClass({
        ...
        return (
            <div className="flex-column wizard-step" id='WizardStep2'>
                ...
                <div className='flex-row upload'>
                    ...
                    <p>Upload an MP3/WAV to add to your tracks. {this.props.songs.length > 1 ? 'Multiple files will be joined.': ''}</p>
                </div>
...
module.exports = TrackWizardStep2;
